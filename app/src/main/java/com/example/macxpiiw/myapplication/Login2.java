    ...
    public class checklogin extends AsyncTask<Void, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("admin")||result.equals("user")){
                ...
                Toast.makeText(Login2.this, "Login OK  : "+result, Toast.LENGTH_SHORT).show();
                Intent newActivity = new Intent(Login2.this,DownloadPage.class);
                newActivity.putExtra("USERID" , userlogin);
                startActivity(newActivity);
                ...
                Toast.makeText(Login2.this, "กรอกรหัสผ่านผิดพลาด ", Toast.LENGTH_SHORT).show();

            }
            else{
                Toast.makeText(Login2.this, "เกิดความผิดพลาด กรุณาลองใหม่ ", Toast.LENGTH_SHORT).show();
