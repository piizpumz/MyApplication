        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.farm_menu){
                    ...
                    Intent intent4 = new Intent(UploadPage.this , Login2.class);
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        MenuItem select = menu.findItem(R.id.select_all);
...
//                public void run() {
        ...
        public String testaom6(){
            ...
            Log.d("result", String.valueOf(dbHelper.UploadImage(a,b,userid).length()));
